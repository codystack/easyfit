        ...
        <section className="container">
            <div className="row pt-5 mt-n2 mt-sm-0 mt-md-2 mt-lg-4 mt-xl-5 mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg">By using Easy Fit Healthy Meals website services and tools (the "Site"), you ("you" or the "End User") agree
                        to the terms and conditions that we ("Easy Fit Healthy Meals") have provided. If you do not agree with the
                        outlined terms and conditions (the "Terms of Use" or "Agreement"), please refrain from using the Site.</p>
                    <p className="fs-lg">For the purpose of these terms of use, wherever the context requires, ‘You’ shall mean any natural or
                        legal person who has agreed to make use of the site.</p>
                    <p className='fs-lg'>The Site reserves the right, to change, modify, add, or remove portions of these Terms and Conditions of
                        use at any time.</p>
                    <p className='fs-lg'>Please check these Terms and Conditions regularly for updates as changes will be made on the website
                        with no notice provided.</p>
                    <p className='fs-lg'>These Terms & Conditions were most recently updated on 28th August 2018 and apply to sales to
                        consumers. Subsequent changes would be stated with the clauses inclusive.</p>
                    <p className='fs-lg'>Your continued use of the Site following the posting of changes to these Terms and Conditions of use
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>1.1</b> This Agreement sets forth the terms and conditions that apply to the use of this Site by the End User.
                        By using this Site (other than to read this Agreement for the first time), End User agrees to comply with
                        all of the terms and conditions hereof. The right to use this Site is personal to End-User and is not
                    ...
                    <p className="fs-lg"><b>1.2</b> End User shall be responsible for protecting the confidentiality of End User's password(s), if any. End
                        ...
                        interruptions in service or events that are beyond the control of Easy Fit Healthy Meals, and Easy Fit Healthy Meals shall
                        not be responsible for any data lost while transmitting information on the Internet. While it is Easy Fit Healthy Meals objective to make the Site accessible 24 hours per day, 7 days per week, the Site may be
                        ...
                        Easy Fit Healthy Meals, access to the Site may be interrupted, suspended or terminated from time to time.
                        Easy Fit Healthy Meals shall have the right at any time to change or discontinue any aspect or feature of Easy Fit Healthy Meals, including, but not limited to, content, hours of availability and equipment needed for access or use.
                        Further, Easy Fit Healthy Meals may discontinue disseminating any portion of information or category of
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>2.1</b> Anything that you submit to the Site and/or provide to us, including but not limited to, questions,
                    ...
                    <p className="fs-lg"><b>2.4</b> We view protection of your privacy as a very important principle. We understand clearly that you and
                        ...
                        and procedures our current Privacy Policy is available at https://www.easyfithealtymeal.com. If you object
                        to your Information being transferred or used in this way please do not use Easy Fit Healthy Meals Website.</p>
                </div>
            </div>
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    ...
                    <p className="fs-lg"><b>3.2</b> Please note that there are cases when an order cannot be processed for various reasons. The Site
                    ...
                    <p className="fs-lg"><b>3.3</b> We are determined to provide the most accurate pricing information on the Site to our users;
                        however, errors may still occur, such as cases when the price of an item is not displayed correctly on the
                        website. If we discover an error in the price of goods you have ordered we will inform you as soon as
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>4.1</b> This website is operated by Demanta Nigeria Limited ("we", "us" or "our"). By using Easy Fit Healthy Meals
                        website you are bound by these Terms & Conditions. All use and purchases made on this website are governed by these Terms & Conditions at any time although the Terms & Conditions governing any given
                        ...
                        applicable to your site visit or purchase. To assist you in determining whether the Terms & Conditions
                    ...
                    <p className="fs-lg"><b>4.2</b> We sell goods only to end-users.</p>
                    <p className="fs-lg"><b>4.3</b> We will confirm your order whether placed directly by using Easy Fit Healthy Meals website, the email,
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    ...
                    <a href="mailto:wecare@easyfitmeal.com"> wecare@easyfitmeal.com</a> or a call placed through to 09121879734 or any other customer care line
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>6.1</b> Payment may be made on the website, and bank transfer. In the case of bank
                    transfers, a proof of payment MUST be sent to <a href="mailto:wecare@easyfitmeal.com"> wecare@easyfitmeal.com</a> before order is
                    dispatched.</p>
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>7.1</b> Delivery days and times are Mondays - Saturdays 9am-6pm and Sunday 1pm-5pm. Delivery will be
                        made to the address specified by you when you register on the website. You have the ability to change
                        this address through the "Account & Profile Details" feature on the website, and you must do so if you
                    ...
                    <p className="fs-lg"><b>7.4</b> Easy Fit Healthy Meals will be responsible for the delivery of the Goods you have ordered to your
                        address. Until the time that the Goods are delivered to you, the Goods shall remain the property of The
                        Easy Fit Healthy Meals and title (together with risk of loss and damage) will not pass to you until the goods are
                    ...
                    <p className="fs-lg"><b>7.8</b> Easy Fit Healthy Meals will ordinarily only make deliveries when an appropriate person is able to receive
                        the delivery.</p>
                </div>
            </div>
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    ...
                    <p className="fs-lg"><b>9.1.5</b> All sealed items must not be opened otherwise it would not be accepted on return. Easy Fit Healthy Meals will only accept unsealed items in cases where maggots, insects or moulds are found in the item.</p>
                    <p className="fs-lg"><b>9.2</b> Return Approval of All returned items are subject to inspection and approval by the authorized
                        representative of Easy Fit Healthy Meals . For a returned item to be approved for return, it must be in an ‘as
                    ...
                    <p className="fs-lg"><b>9.4</b> You will be asked to choose one of the following options:<br />
                        ...
                        shipping goods back to Easy Fit Healthy Meals. The period of refund will not exceed 10 working days from
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>10.1</b> Any Customer complaints should be addressed to Easy Fit Healthy Meals Customer Care Line
                        09121879734 or any other customer care line stated on the website. An email should be sent to 
                        <a href="mailto:wecare@easyfitmeal.com"> wecare@easyfitmeal.com</a></p>
                </div>
            </div>
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    ...
                    <p className="fs-lg"><b>12.2</b> In addition to our right to cancel your order, we reserve the right to suspend your account. Your
                        account will remain suspended until you contact our call centre on 07011664841 and remedy any
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>13.1</b> All intellectual property rights, whether registered or unregistered, in the Site, information content on
                    ...
                    <p className="fs-lg"><b>13.2</b> The entire contents of the Site also are protected by copyright as a collective work under Nigeria
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg"><b>14.1</b> These Terms and Conditions shall be interpreted and governed by the laws in force in the Federal
                        Republic of Nigeria. The place of jurisdiction shall be Lagos, Nigeria.</p>
                    <p className="fs-lg"><b>14.2</b> Unless otherwise specified, the material on Easy Fit Healthy Meals is presented solely for the purpose of
                        sale in Nigeria unless otherwise stated. Easy Fit Healthy Meals makes no representation that materials on the
                        site are appropriate or available for use in other locations/Countries other than Nigeria unless otherwise
                        stated. Those who choose to access this site from other locations/Countries other than Nigeria do so on
                        their own initiative and Easy Fit Healthy Meals is not responsible for supply of goods/refund for the goods
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    ...
                    <p className="fs-lg"><b>15.2</b> Upon any termination of this Agreement, you shall immediately cease all access to and use of the
                        Site and we shall, in addition to any other legal or equitable remedies, immediately revoke all
                    ...
                    <p className="fs-lg"><b>15.3</b> Any termination of this agreement shall not affect the respective rights and obligations (including
                        ...
                        furthermore agree that the Site shall not be liable to you or to any other person as a result of any such
                        suspension or termination.</p>
                    <p className="fs-lg"><b>15.4</b> If you are dissatisfied with the Site or with any terms, conditions, rules, policies, guidelines, or
                        practices of Easy Fit Healthy Meals in operating the Site, your sole and exclusive remedy is to discontinue
                        using the Site.</p>
                </div>
            </div>
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg">16.1 Easy Fit Healthy Meals tries to be as accurate as possible. However, Easy Fit Healthy Meals does not
                        warrant that product description or other content of this site is accurate, complete, reliable, current, or
                        error-free. If a product offered by Easy Fit Healthy Meals itself is not as described, your sole remedy is to
            ...
            <div className="row mb-5">
                ...
                <div className="col-md-8 col-xl-8">
                    <p className="fs-lg">17.1 IN NO EVENT SHALL Easy Fit Healthy Meals BE LIABLE FOR ANY SPECIAL, INCIDENTAL,
                        INDIRECT OR CONSEQUENTIAL DAMAGES OF ANY KIND IN CONNECTION WITH THIS
                        AGREEMENT, EVEN IF Easy Fit Healthy Meals HAS BEEN INFORMED IN ADVANCE OF THE
