    ...
    <>
        <section className="bg-secondary">
            ...
            <div className="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
                <div className="bg-primary rounded-5 position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in" data-aos-duration={600} data-aos-offset={300} data-disable-parallax-down="lg" />
                ...
                <div className="col-md-6 col-lg-5 offset-xl-1">
                    ...
                    <div className="d-none d-md-block position-relative mx-auto" style={{maxWidth: '484px'}}>
                    <div className="position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in" data-aos-duration={400} data-aos-delay={600} data-aos-offset={300} data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                        <svg className="text-warning position-absolute top-0 start-0 w-100 h-100" width={484} height={590} viewBox="0 0 484 590" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M42.4929 62.8378C31.073 56.0023 17.3524 50.4482 4.32343 47.5959C3.18562 47.3476 2.05922 48.0685 1.81258 49.2044C1.56593 50.3402 2.28436 51.4658 3.42217 51.7141C16.0197 54.4726 29.2896 59.844 40.327 66.4552C41.3271 67.052 42.6231 66.7263 43.2192 65.7286C43.8152 64.7309 43.493 63.4346 42.4929 62.8378Z" />
                        <path d="M51.1742 57.6399C50.0172 48.6073 44.9377 40.4608 39.1682 33.66C38.4115 32.7739 37.0807 32.6648 36.1979 33.4154C35.3087 34.1687 35.2011 35.4998 35.9511 36.3879C41.2085 42.5807 45.9377 49.949 46.9927 58.1754C47.1402 59.3297 48.1987 60.1459 49.3501 59.9984C50.5016 59.8517 51.3216 58.7935 51.1742 57.6399Z" />
                        </svg>
                    </div><img src="assets/img/landing/mobile-app-showcase/cta-screens.png" alt="App screens" data-aos="fade-left" data-aos-duration={600} data-aos-delay={200} data-aos-offset={300} data-disable-parallax-down="lg" />
                    </div>
                </div>
                </div>
            </div>
